...
public class EulerBootPropertySourceTest {
...
//    }
    ...
    public void getDefaultLocaleArray() throws PropertyNotFoundException {
        EulerBootPropertySource eulerBootPropertySource = new EulerBootPropertySource(SingleValueConfigurableEnvironment.of(null), new EulerApplicationProperties(), new EulerWebProperties(), new EulerCacheProperties());
        ...
        Assert.assertArrayEquals(new Locale[]{Locale.CHINA, Locale.US}, eulerBootPropertySource.getProperty(WebConfigKey.WEB_LANGUAGE_SUPPORT_LANGUAGES, Locale[].class));
    }
